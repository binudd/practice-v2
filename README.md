...
overview (UI / Zustand / SWR / Services / Domain / Infra) and the
[store README](./src/store/README.md) / [domain README](./src/domain/README.md)
for when to add a new store or domain module.
